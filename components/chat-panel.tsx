  ...
  return (
    ...
    >
      ...
      <form
        ...
        className={cn(
          'w-full max-w-full md:max-w-[90%] lg:max-w-[85%] xl:max-w-[80%] mx-auto',
          messages.length > 0 ? 'px-2 sm:px-4 py-4' : 'px-4 sm:px-6'
        )}
      >
        <div className="relative flex flex-col w-full gap-2 bg-muted rounded-3xl border border-input">
          ...
          {/* Bottom menu area */}
          <div className="flex flex-wrap sm:flex-nowrap items-center justify-between p-2 sm:p-3">
